...
public class WordDaoTest {
    ...
    public void insertAndGetWord() throws Exception {
        Word word = new Word("word","titulo");
        ...
        assertEquals(allWords.get(0).getmTitulo(), word.getmTitulo());
    }

    @Test
    public void getAllWords() throws Exception {
        Word word = new Word("aaa", "aa");
        mWordDao.insert(word);
        Word word2 = new Word("bbb", "bb");
    ...
    public void deleteAll() throws Exception {
        Word word = new Word("word", "titulo");
        mWordDao.insert(word);
        Word word2 = new Word("word2", "titulo2");
        mWordDao.insert(word2);
        mWordDao.deleteAll();
        List<Word> allWords = LiveDataTestUtil.getValue(mWordDao.getAlphabetizedWords());
